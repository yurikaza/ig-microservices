package com.ig.commentReplay.controllers;
...
import com.ig.commentReplay.repository.CommentRepository;
...
public class ComentController {
	...
	public Optional<Comment> saveBook(@RequestBody Comment comment, @PathVariable int commentId) {
